...
export default function status(state=initialState, action) {
  switch (action.type) {
    ...
    case ALLERGENS_FETCH_REJECTED: return { ...state, fetchAllergens: REJECTED }
    ...
    case LOCATIONS_FETCH_REJECTED: return { ...state,  fetchLocations: REJECTED }

    case MENUS_FETCH_START: return { ...state,   fetchMenu: PENDING }
    case MENUS_FETCH_SUCCESS: return { ...state, fetchMenu: FULFILLED }
    case MENUS_FETCH_REJECTED: return { ...state,  fetchMenu: REJECTED }
